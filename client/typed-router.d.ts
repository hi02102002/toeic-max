...
declare module 'vue-router/auto-routes' {
  ...
  export interface RouteNamedMap {
    ...
    '/dashboard/results-vocab/[historyId]': RouteRecordInfo<'/dashboard/results-vocab/[historyId]', '/dashboard/results-vocab/:historyId', { historyId: ParamValue<true> }, { historyId: ParamValue<false> }>,
